...
import { toolGroups } from '@/data/catalogData';

interface ToolGroupGridProps {
  onGroupSelect: (groupId: string) => void;
}

export const ToolGroupGrid = ({ onGroupSelect }: ToolGroupGridProps) => {
  return (
